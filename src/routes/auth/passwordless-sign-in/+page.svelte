...
<div>
	<div class="flex gap-10">
		<a href="/auth/passwordless-sign-in" class="variant-filled-primary btn grow basis-1/2">email</a>

		<a href="/auth/sign-in" class="variant-outline-primary btn grow basis-1/2">
			email + password
		</a>
	</div>
